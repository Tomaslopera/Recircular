import {
  ...
  memoize,
  unitlessKeys
} from "./chunk-MTVD4GSQ.js";
import {
  require_prop_types,
  require_react_is
} from "./chunk-D7TZQQ2B.js";
import {
  require_react
...
var useInsertionEffect2 = React9["useInsertionEffect"] ? React9["useInsertionEffect"] : false;
var useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect2 || syncFallback;
var useInsertionEffectWithLayoutFallback = useInsertionEffect2 || React9.useLayoutEffect;

// node_modules/@emotion/react/dist/emotion-element-c39617d8.browser.esm.js
var isBrowser2 = true;
var hasOwnProperty = {}.hasOwnProperty;
var EmotionCacheContext = React10.createContext(
...
var ThemeContext = React10.createContext({});
if (true) {
...
var Global = withEmotionCache(function(props, cache2) {
  ...
  var serialized = serializeStyles([styles], void 0, React11.useContext(ThemeContext));
  if (!isBrowser2) {
    var _ref;
    ...
    return React11.createElement("style", (_ref = {}, _ref["data-emotion"] = cache2.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
...
var SvgIcon = React29.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React29.isValidElement(children) && children.type === "svg";
  const ownerState = _extends({}, props, {
    color: color2,
    component,
    fontSize: fontSize2,
...
function createSvgIcon(path, displayName) {
  ...
  return React30.memo(React30.forwardRef(Component));
}
...
var Star_default = createSvgIcon((0, import_jsx_runtime16.jsx)("path", {
...
var StarBorder_default = createSvgIcon((0, import_jsx_runtime17.jsx)("path", {
...
var _excluded17 = ["value"];
var _excluded23 = ["className", "defaultValue", "disabled", "emptyIcon", "emptyLabelText", "getLabelText", "highlightSelectedOnly", "icon", "IconContainerComponent", "max", "name", "onChange", "onChangeActive", "onMouseLeave", "onMouseMove", "precision", "readOnly", "size", "value"];
...
function IconContainer(props) {
  const other = _objectWithoutPropertiesLoose(props, _excluded17);
  return (0, import_jsx_runtime18.jsx)("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  const container = (0, import_jsx_runtime18.jsx)(RatingIcon, {
  ...
  if (readOnly) {
    return (0, import_jsx_runtime18.jsx)("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return (0, import_jsx_runtime19.jsxs)(React33.Fragment, {
    children: [(0, import_jsx_runtime19.jsxs)(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
        emptyValueFocused: void 0
      }),
      htmlFor: id
    }, labelProps, {
      children: [container, (0, import_jsx_runtime18.jsx)("span", {
...
true ? RatingItem.propTypes = {
  ...
  disabled: import_prop_types20.default.bool.isRequired,
  emptyIcon: import_prop_types20.default.node,
  focus: import_prop_types20.default.number.isRequired,
  getLabelText: import_prop_types20.default.func.isRequired,
  highlightSelectedOnly: import_prop_types20.default.bool.isRequired,
  hover: import_prop_types20.default.number.isRequired,
  icon: import_prop_types20.default.node,
  IconContainerComponent: import_prop_types20.default.elementType.isRequired,
  isActive: import_prop_types20.default.bool.isRequired,
  itemValue: import_prop_types20.default.number.isRequired,
  labelProps: import_prop_types20.default.object,
  name: import_prop_types20.default.string,
  onBlur: import_prop_types20.default.func.isRequired,
  onChange: import_prop_types20.default.func.isRequired,
  onClick: import_prop_types20.default.func.isRequired,
  onFocus: import_prop_types20.default.func.isRequired,
  ownerState: import_prop_types20.default.object.isRequired,
  ratingValue: import_prop_types20.default.number,
  ratingValueRounded: import_prop_types20.default.number,
  readOnly: import_prop_types20.default.bool.isRequired
} : void 0;
var defaultIcon = (0, import_jsx_runtime18.jsx)(Star_default, {
  fontSize: "inherit"
});
var defaultEmptyIcon = (0, import_jsx_runtime18.jsx)(StarBorder_default, {
  fontSize: "inherit"
});
function defaultLabelText(value) {
  return `${value} Star${value !== 1 ? "s" : ""}`;
}
var Rating = React33.forwardRef(function Rating2(inProps, ref) {
  const props = useThemeProps2({
    name: "MuiRating",
    props: inProps
  });
  ...
  const handleMouseMove = (event) => {
    ...
    newHover = clamp2(newHover, precision, max);
  ...
  const [emptyValueFocused, setEmptyValueFocused] = React33.useState(false);
  const ownerState = _extends({}, props, {
    defaultValue,
    disabled,
    emptyIcon,
  ...
  return (0, import_jsx_runtime19.jsxs)(RatingRoot, _extends({
    ref: handleRef,
    ...
    children: [Array.from(new Array(max)).map((_, index) => {
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime18.jsx)(RatingDecimal, {
          className: clsx_default(classes.decimal, isActive && classes.iconActive),
          ownerState,
          iconActive: isActive,
          children: items.map(($, indexDecimal) => {
            const itemDecimalValue = roundValueToPrecision(itemValue - 1 + (indexDecimal + 1) * precision, precision);
            return (0, import_jsx_runtime18.jsx)(RatingItem, _extends({}, ratingItemProps, {
    ...
    }), !readOnly && !disabled && (0, import_jsx_runtime19.jsxs)(RatingLabel, {
      className: clsx_default(classes.label, classes.labelEmptyValue),
      ownerState,
      children: [(0, import_jsx_runtime18.jsx)("input", {
        className: classes.visuallyHidden,
        value: "",
        id: `${name}-empty`,
        type: "radio",
...
true ? Rating.propTypes = {
   ...
   * @default 'Empty'
   */
  emptyLabelText: import_prop_types20.default.node,
  /**
   ...
   * }
   */
  getLabelText: import_prop_types20.default.func,
  /**
   * If `true`, only the selected icon will be highlighted.
   * @default false
   */
  highlightSelectedOnly: import_prop_types20.default.bool,
  /**
   * The icon to display.
   ...
   * }
   */
  IconContainerComponent: import_prop_types20.default.elementType,
  /**
   * Maximum rating.
   * @default 5
   */
   ...
   */
  onChangeActive: import_prop_types20.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onMouseMove: import_prop_types20.default.func,
  /**
   * The minimum increment value change allowed.
   * @default 1
   */
  precision: chainPropTypes(import_prop_types20.default.number, (props) => {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4XQWIT3J.js.map
